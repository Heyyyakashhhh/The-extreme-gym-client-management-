...
export const ClientList: React.FC<ClientListProps> = ({ clients, onRenew, onEdit, onDelete }) => {
  return (
    <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
      <h3 className="text-2xl font-bold text-cyan-400 mb-6">Client Roster</h3>
      {clients.length > 0 ? (
        ...
        <p className="text-gray-400 text-center py-8">No clients found. Add a new client to get started.</p>
      )}
    </div>
  );
};